...
pub use scanner::{
    deep_scan_repo, scan, scan_capabilities, scan_deep, scan_files, scan_history, scan_node_modules,
    scan_repo, scan_streaming, scan_tree, RepoScanEvent, ScanPhase, ScanReport,
};
pub use walk::{
